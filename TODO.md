# GeoSustain Hackathon Build TODO

- [x] Scaffold project structure (frontend + Express backend)
- [x] Implement Express API proxy routes for Open-Meteo geocoding, air quality, and weather
- [x] Build frontend: Leaflet map, city search, marker coloring, and 7-day trend chart
